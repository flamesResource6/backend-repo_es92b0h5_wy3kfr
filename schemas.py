...
# --------------------------------------------------
# Priceless Energy LTD - Website lead/appointment schema
# --------------------------------------------------

class Appointment(BaseModel):
    """Appointments/Leads collected from website form
    ...
    datetime: Optional[str] = Field(None, description="Preferred date and time as string")
